...
from navistore.backend.restkit import __version__, request, set_logging
from navistore.backend.restkit.util.misc import popen3, locate_program
...
def main():
    ...
    if opts.shell:
        try:
            from navistore.backend.restkit.contrib import ipython_shell as shell
