...
from navistore.backend.restkit.filters.basicauth import BasicAuth
from navistore.backend.restkit.filters.oauth2 import OAuthFilter
from navistore.backend.restkit.filters.simpleproxy import SimpleProxy
