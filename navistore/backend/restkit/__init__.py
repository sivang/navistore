...
try:
    from navistore.backend.restkit.errors import ResourceNotFound, Unauthorized, RequestFailed,\
RedirectLimit, RequestError, InvalidUrl, ResponseError, ProxyError, ResourceError
    from navistore.backend.restkit.client import HttpConnection, HttpResponse, MAX_FOLLOW_REDIRECTS
    from navistore.backend.restkit.resource import Resource
    from navistore.backend.restkit.pool.simple import SimplePool
    from navistore.backend.restkit.filters import BasicAuth, SimpleProxy, OAuthFilter
except ImportError:
    import traceback
    traceback.print_exc()
...
from navistore.backend.restkit.util.sock import _GLOBAL_DEFAULT_TIMEOUT
